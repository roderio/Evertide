...
<body class="min-h-screen text-white font-sans opacity-0 transition-opacity duration-500 ease-in-out" id="body-content">
    ...
    <main class="pt-32 pb-24 px-6">
        <div class="max-w-2xl mx-auto glass-panel rounded-3xl p-8 md:p-12 animate-slide-up">
            ...
            <form class="space-y-8">
                <!-- Shipping Details -->
                <div>
                    <h3 class="text-sm uppercase tracking-wider font-bold text-gray-400 mb-4">Shipping Information</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="text"
                            class="col-span-1 md:col-span-2 w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                            placeholder="Street Address" id="address">
                        <input type="text"
                            class="w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                            placeholder="City" id="city">
                        <input type="text"
                            class="w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                            placeholder="State/Province" id="state">
                        <input type="text"
                            class="col-span-1 md:col-span-2 w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                ...
                <!-- Payment Method -->
                <div>
                    <h3 class="text-sm uppercase tracking-wider font-bold text-gray-400 mb-4">Payment Method</h3>
                    <div class="space-y-4">
                        <div class="relative">
                            <input type="text"
                                class="w-full bg-black/40 border border-white/10 rounded-xl p-4 pl-12 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                                placeholder="Card Number" id="card-number">
                            <svg class="w-6 h-6 text-gray-500 absolute left-4 top-1/2 -translate-y-1/2" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="pt-4">
                    <button type="button"
                        class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-green-600/25 hover:-translate-y-1 flex items-center justify-center gap-2 text-lg">
                        Complete Order
                    </button>
    ...
    <script>
        ...
        setTimeout(() => { document.body.classList.remove('opacity-0'); }, 800);
    </script>
</body>
