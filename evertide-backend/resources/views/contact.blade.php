...
<body class="min-h-screen text-white font-sans opacity-0 transition-opacity duration-500 ease-in-out" id="body-content">
    ...
    <header
        ...
        <div class="max-w-7xl mx-auto h-full flex justify-between items-center">
            ...
            <nav class="hidden md:flex gap-8 items-center">
                ...
                <a href="{{ route('contact') }}" class="text-sm font-medium text-blue-400">Contact</a>
            </nav>
    ...
    <main class="pt-32 pb-24 px-6">
        <div class="max-w-2xl mx-auto glass-panel rounded-3xl p-8 md:p-12 animate-slide-up">
            ...
            <p class="text-gray-400 text-center mb-10">Have a question or need a custom quote? We're here to help.</p>
            <!-- Contact Form -->
            <form class="space-y-6">
                <div>
                    <label for="name" class="block text-gray-400 mb-2 text-sm font-medium">Name</label>
                ...
                <div>
                    <label for="email" class="block text-gray-400 mb-2 text-sm font-medium">Email</label>
                    <input type="email" id="email"
                        class="w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors"
                        placeholder="you@example.com">
                </div>
                <div>
                    <label for="message" class="block text-gray-400 mb-2 text-sm font-medium">Message</label>
