...
<body class="min-h-screen text-white font-sans opacity-0 transition-opacity duration-500 ease-in-out" id="body-content">
    ...
    <!-- Main Content -->
    <main class="pt-32 pb-24 px-6 min-h-[85vh] flex items-center justify-center">
        <div class="w-full max-w-lg glass-panel rounded-3xl p-8 md:p-10 animate-slide-up bg-black/40">
            <h1 class="text-3xl font-bold mb-2 text-center">Join Evertide</h1>
            <p class="text-gray-400 text-center mb-8">Create an account to start your journey.</p>
            <!-- Register Form -->
            <form class="space-y-5">
                <div>
                    <label for="name" class="block text-gray-400 mb-2 text-sm font-medium">Full Name</label>
                    <div class="relative">
                ...
                <div>
                    <label for="confirm-password" class="block text-gray-400 mb-2 text-sm font-medium">Confirm
                        Password</label>
                    <div class="relative">
                ...
                <div class="pt-2">
                    <button type="button"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-blue-600/25 hover:-translate-y-1">
                        Create Account
                    </button>
                </div>
            </form>
            <div class="mt-8 text-center">
                <p class="text-gray-400">
                    Already have an account? <a href="{{ route('login') }}"
                        class="text-white hover:text-blue-400 font-bold transition-colors">Sign In</a>
                </p>
            </div>
        </div>
    </main>
