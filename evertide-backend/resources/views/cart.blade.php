...
<body class="min-h-screen text-white font-sans opacity-0 transition-opacity duration-500 ease-in-out" id="body-content">
    ...
    <main class="pt-32 pb-24 px-6">
        <div class="max-w-4xl mx-auto glass-panel rounded-3xl p-8 md:p-12 animate-slide-up">
            <h1 class="text-3xl md:text-4xl font-bold mb-8 flex items-center gap-4">
                Your Cart
                <span class="text-lg font-normal text-gray-500 bg-white/5 px-3 py-1 rounded-full border border-white/5"
                    id="cart-count-badge">Items</span>
            </h1>
            <div id="cart-items" class="flex flex-col gap-4 mb-8 min-h-[200px]">
                <p class="text-gray-500 italic text-center py-12">Your cart is empty.</p>
            </div>
            <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 gap-6">
                <div class="text-left">
                    ...
                    <h3 class="text-4xl font-bold text-white leading-none">$<span id="cart-total">0.00</span></h3>
                </div>
                <button onclick="window.location.href='payment.html'"
                    class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-12 rounded-xl transition-all shadow-lg hover:shadow-blue-600/25 hover:-translate-y-1 flex items-center justify-center gap-2">
