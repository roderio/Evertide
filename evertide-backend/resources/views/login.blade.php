...
<body class="min-h-screen text-white font-sans opacity-0 transition-opacity duration-500 ease-in-out" id="body-content">
    ...
    <header
        ...
        <div class="max-w-7xl mx-auto h-full flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center">
                ...
                <a href="{{ route('login') }}" class="hidden md:block text-sm font-medium text-blue-400">Sign In</a>
                <a href="{{ route('store') }}"
    ...
    <!-- Main Content -->
    <main class="pt-32 pb-24 px-6 min-h-[80vh] flex items-center justify-center">
        <div class="w-full max-w-md glass-panel rounded-3xl p-8 md:p-10 animate-slide-up bg-black/40">
            <h1 class="text-3xl font-bold mb-2 text-center">Welcome Back</h1>
            <p class="text-gray-400 text-center mb-8">Sign in to access your saved builds.</p>
            <!-- Login Form -->
            <form class="space-y-6">
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        <label for="password" class="block text-gray-400 text-sm font-medium">Password</label>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-400">
                    Don't have an account? <a href="{{ route('register') }}"
                        class="text-white hover:text-blue-400 font-bold transition-colors">Sign Up</a>
                </p>
            </div>
        </div>
    </main>
